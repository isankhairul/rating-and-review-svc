...
// FindRatingSubmissionByUserIDLegacyAndRatingID provides a mock function with given fields: userIdLegacy, ratingId, sourceTransId
func (_m *RatingMpRepository) FindRatingSubmissionByUserIDLegacyAndRatingID(userIdLegacy *string, ratingId string, sourceTransId string) (*entity.RatingSubmissionMp, error) {
	ret := _m.Called(userIdLegacy, ratingId, sourceTransId)

	var r0 *entity.RatingSubmissionMp
	if rf, ok := ret.Get(0).(func(*string, string, string) *entity.RatingSubmissionMp); ok {
		r0 = rf(userIdLegacy, ratingId, sourceTransId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.RatingSubmissionMp)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*string, string, string) error); ok {
		r1 = rf(userIdLegacy, ratingId, sourceTransId)
	} else {
		r1 = ret.Error(1)
	}
